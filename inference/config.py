...
# 推理引擎是 onnxruntime：目录里放恰好一个 .onnx 即可换模型。
MODEL_DIR = PROJECT_ROOT / "models"
PERSON_DETECTOR_DIR = MODEL_DIR / "onnx/person_detector"
PERSON_ATTRIBUTE_DIR = MODEL_DIR / "onnx/person_attribute"
VEHICLE_DETECTOR_DIR = MODEL_DIR / "onnx/vehicle_detector"
VEHICLE_ATTRIBUTE_DIR = MODEL_DIR / "onnx/vehicle_attribute"
